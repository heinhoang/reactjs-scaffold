...
class Login extends Component {
    login = values => this.props.userLogin(values, this.props.location.state ? this.props.location.state.nextPath : '/');
...
Login.propTypes = {
    ...propTypes,
    theme: PropTypes.object.isRequired, // theming
    userLogin: PropTypes.func.isRequired, // login behavior
    translate: PropTypes.func.isRequired, // translate
};

Login.defaultProps = {
    theme: defaultTheme, // theming
};
